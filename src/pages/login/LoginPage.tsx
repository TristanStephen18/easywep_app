        ...
        <div className="bg-white h-[36px] flex items-center border-b border-gray-200">
          <div className="max-w-[1200px] mx-auto w-full px-[15px] flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              <a href="#" className="text-gray-700 text-[13px] font-normal hover:text-black">
                Personal
              </a>
              <a href="#" className="text-[#008a00] text-[13px] font-normal hover:text-black hover:underline">
                Business
              </a>
              <a href="#" className="text-[#008a00] text-[13px] font-normal hover:text-black hover:underline">
                Investing
            ...
            <div className="flex items-center gap-4">
              <button className="flex items-center gap-1 text-gray-700 hover:text-black text-xs">
                <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 640 480'%3E%3Cpath fill='%23fff' d='M0 0h640v480H0z'/%3E%3Cpath fill='%23d52b1e' d='M0 0h213.3v480H0zm426.7 0H640v480H426.7z'/%3E%3C/svg%3E" alt="Canada" className="w-4 h-3" />
                <ChevronDown size={12} />
              </button>
              <a href="#" className="text-gray-700 hover:text-black text-xs hover:underline">
                Français
              </a>
            </div>
          </div>
          ...
          <div className="max-w-[1200px] mx-auto px-[15px] w-full flex items-center justify-between">
            ...
            <div className="flex items-center gap-8">
              ...
              <nav className="flex items-center gap-6">
                <a href="#" className="text-white text-[16px] leading-[22px] font-normal hover:underline">
                  My Accounts
                </a>
                <a href="#" className="text-white text-[16px] leading-[22px] font-normal hover:underline">
                  How To
      ...
      <main className="max-w-[1200px] mx-auto px-[15px] py-6">
        ...
        <div className="bg-[#f5f9f7] pt-4 px-8 pb-8 grid grid-cols-1 lg:grid-cols-2 gap-x-12 relative">
          ...
          <div className="border-r border-gray-300 pr-12">
            <form className="space-y-6">
              ...
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember" className="ml-2 text-sm text-[#1c1c1c]">
                  Remember me
                </label>
              </div>
              ...
              {/* Helper Links */}
              <div className="pt-4">
                <a href="#" className="block text-[#008a00] text-sm hover:underline mb-2">
                  Forgot your username or password?
                </a>
                <a href="#" className="flex items-center gap-2 text-[#008a00] text-sm hover:underline">
                  <Lock size={14} />
          ...
          <div className="pl-12">
            ...
            {/* Login Help */}
            <div className="mb-6">
              <h3 className="text-[#1c1c1c] text-[20px] leading-[30px] font-normal mb-2">Login Help</h3>
              <div className="space-y-1">
                <a href="#" className="block text-[#008a00] text-[16px] leading-[22px] font-normal hover:underline">
                  Get Login Help ›
                </a>
                <a href="#" className="block text-[#008a00] text-[16px] leading-[22px] font-normal hover:underline">
                  Reset Password ›
            ...
            {/* Enhanced Security */}
            <div className="mb-6">
              <h3 className="text-[#1c1c1c] text-[20px] leading-[30px] font-normal mb-2">Enhanced Security</h3>
              <div className="space-y-1">
                <a href="#" className="block text-[#008a00] text-[16px] leading-[22px] font-normal hover:underline">
                  Two-Step Verification FAQs ›
                </a>
                <a href="#" className="block text-[#008a00] text-[16px] leading-[22px] font-normal hover:underline">
                  TD Authenticate app: Securely log in from anywhere in the world without texts or phone calls. ›
                </a>
                <a href="#" className="block text-[#008a00] text-[16px] leading-[22px] font-normal hover:underline">
            ...
            {/* Mobile Banking */}
            <div>
              <h3 className="text-[#1c1c1c] text-[20px] leading-[30px] font-normal mb-2">Explore mobile banking with the TD app now</h3>
              <a href="#" className="block text-[#008a00] text-[16px] leading-[22px] font-normal hover:underline">
          ...
          <div className="flex flex-row items-center justify-center gap-12">
            ...
            <div>
              ...
              <p className="text-[#1c1c1c] text-sm mt-3 mb-6 max-w-md">
                All you have to do is decide how much to spend, then pick a stock. It's easy, no matter how you slice it.
              </p>
        ...
        <div className="max-w-[1000px] mx-auto px-6">
          <p className="text-[16px] leading-[22px] font-normal text-[#1c1c1c]">
            By using EasyWeb, our secured financial services site, offered by TD Canada Trust and its affiliates, you agree to the terms and services of the{' '}
            <a href="#" className="text-[#008a00] underline hover:text-[#006d00]">Financial Services Terms</a>, {' '}
            <a href="#" className="text-[#008a00] underline hover:text-[#006d00]">Access Agreement</a>, {' '}
            <a href="#" className="text-[#008a00] underline hover:text-[#006d00]">Digital Banking Agreement</a>, {' '}
            <a href="#" className="text-[#008a00] underline hover:text-[#006d00]">Business Access Services Schedule</a>, and/or {' '}
            <a href="#" className="text-[#008a00] underline hover:text-[#006d00]">Terms and Agreement</a>, {' '}
            <a href="#" className="text-[#008a00] underline hover:text-[#006d00]">Disclosure</a>.
          </p>
        </div>
      </main>
            ...
            <div className="text-center">
              ...
              <div className="mb-10">
                ...
                <div className="flex justify-center gap-3">
                  {/* X (Twitter) */}
                  <a href="#" className="w-8 h-8 rounded-full bg-[#1a4a2e] flex items-center justify-center hover:bg-[#234d35]">
              ...
              <div className="flex flex-wrap justify-center gap-6 text-xs">
                <a href="#" className="text-white hover:underline">Privacy and Security</a>
                <a href="#" className="text-white hover:underline">Legal</a>
                <a href="#" className="text-white hover:underline">Accessibility</a>
                <a href="#" className="text-white hover:underline">CDIC member</a>
                <a href="#" className="text-white hover:underline">About Us</a>
                <a href="#" className="text-white hover:underline">We're Hiring</a>
                <a href="#" className="text-white hover:underline">Manage online experience</a>
                <a href="#" className="text-white hover:underline">Site Index</a>
              </div>
            </div>
          </div>
        </div>
