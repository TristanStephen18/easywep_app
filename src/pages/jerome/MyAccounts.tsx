...
// Import from parent folder since component is in src/pages/
...
export default function MyAccounts() {
  ...
  // Helper function to parse date from transaction date string
  const parseTransactionDate = (dateStr: string): Date => {
    const cleaned = dateStr.trim();
    return new Date(cleaned);
  };
  
  // Helper function to create date from month/day/year selectors
  const createDateFromSelectors = (month: string, day: string, year: string): Date => {
  ...
  // Calculate totals for filtered or all transactions
  const calculateTotals = () => {
    ...
    return {
      withdrawals: `$${totalWithdrawals.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',')}`,
      deposits: `$${totalDeposits.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',')}`
    };
  };
  ...
  const styles = {
    tdGreen: '#007934',
    navBackground: '#00391d',
    navActiveUnderline: '#bed80b',
    linkGreen: '#007934',
    bgGrey: '#f3f3f3',
    borderGrey: '#dcdcdc',
    redText: '#cc0000',
        ...
        <div style={{
          ...
          <div style={{ 
            ...
            <div style={{ padding: '20px', backgroundColor: 'white' }}>
              ...
              {/* Account Selector - NO MONTH SELECTOR BELOW THIS */}
                ...
                padding: '12px 15px'
                  ...
                  <div style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                          ...
                          <option>Pre-Authorized Payments</option>
                          <option>Cheque Transactions</option>
                          <option>Debit Purchases</option>
                          </select>
                      </div>
                  ...
                  <div style={{ fontSize: '13px' }}>
                      <a 
                        href="#" 
                        style={{ color: '#176940', textDecoration: 'none', cursor: 'pointer' }}
                        onClick={(e) => {
                          e.preventDefault();
                  ...
                  {searchExpanded && (
                    <div style={{ 
                      ...
                      <div style={{ marginBottom: '15px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                        ...
                        />
                        <label htmlFor="searchMonth" style={{ fontSize: '13px', color: '#333', cursor: 'pointer' }}>Month</label>
                        ...
                        <span style={{ fontSize: '13px', color: '#333', marginLeft: '5px' }}>Year</span>
                      ...
                      <div style={{ marginBottom: '15px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                        <input 
                          ...
                          style={{ cursor: 'pointer' }}
                        />
                        <label htmlFor="searchRange" style={{ fontSize: '13px', color: '#333', cursor: 'pointer' }}>From</label>
                        ...
                        <button style={{
                          ...
                          <img src="src/assets/calendar.png" alt="calendar" style={{ width: '20px', height: '20px' }} />
                        </button>

                        <span style={{ fontSize: '13px', color: '#333', margin: '0 5px' }}>To</span>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ padding: '4px 10px' }}>{totals.withdrawals}</div>
                    <div style={{ padding: '4px 10px' }}>{totals.deposits}</div>
                    <div></div>
                </div>
            </div>
